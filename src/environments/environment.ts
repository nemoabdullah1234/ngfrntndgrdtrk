...
export const environment = {
  ...
  identityPoolId: 'eu-west-1:29c8a26b-9f1b-40f3-bf4e-7dbebf199ef8',
  projectId: 'eu-west-1_Win4w1vkr',
  clientId: '012179919676',
  userPoolClientId: '43ccnqb1lpdjjk7njl2ugj86pl',
  ...
  secretAccessKey: 'QVfX7Q6Gw+PlYzSZjsdj99a04VOpN/YKTXn5E+tF',
    ...
    server: 'https://guardtrakapi.akwa.io/',
    serverEnv: '/api',
  ...
  adminRole: 'role-guardtrak-akadmin',
  userType: 'Employee',
